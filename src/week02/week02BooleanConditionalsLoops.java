...
public class week02BooleanConditionalsLoops {
	...
	public static void main(String[] args) {
		...
		if (currentAge>=15 & hasLicense) {
			
			System.out.println("This person can drive.");
		} // Why will this work w/o an else statement?
		else {
			System.out.println("This person cannot drive");
		}
		...
		//				iv. If there are 5 or more cookies, print "Jackpot!"
			...
			// Using Boolean - changing the problem to fair sharing
		/*	int numberOfCookiesNew = 7;
			int numberOfChildrenNew = 6;
			if (numberOfCookiesNew % numberOfChildrenNew  <=0){
				System.out.println("Sad Face");
			} else if (numberOfCookiesNew % numberOfChildrenNew  <2 ){
					System.out.println("Yes");
			} else if (numberOfCookiesNew % numberOfChildrenNew <5){
				System.out.println("Whoohooo");
			} else {
				System.out.println("Jackpot!");
			} */
		...
		System.out.println(p + " divided by 3 has a remainder of " + p%3);
			}
